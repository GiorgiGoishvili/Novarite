    ...
    <main className="flex min-h-screen items-center justify-center bg-nr-surface px-5 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="font-sans text-2xl font-extrabold text-nr-ink">Create your account</h1>
        ...
        <p className="mt-5 text-center font-sans text-sm text-nr-muted">
          ...
          <a href="/login" className="font-semibold text-nr-red hover:text-nr-redhover transition-colors">
            Sign in
          </a>
        </p>
      </div>
